<script lang="ts">
	...
	const sampleData: ProfileData = {
		...
		avatar: 'AJ',
		about:
			"I'm a passionate software engineer with 5+ years of experience building scalable web applications. I specialize in React, Node.js, and cloud technologies, with a focus on creating user-centric solutions that drive business growth.",
		workExperience: [
			{
...
<svelte:head>
	...
	<meta
		name="description"
		content="Choose from beautiful CV templates with customizable themes and layouts"
	/>
</svelte:head>
	...
	<div class="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700">
		<div class="container mx-auto px-4 py-8">
			<div class="text-center mb-8">
				<h1 class="text-4xl font-bold text-gray-900 dark:text-white mb-4">Template Marketplace</h1>
				<p class="text-xl text-gray-600 dark:text-gray-300 max-w-2xl mx-auto">
					Choose from our collection of beautiful, professional CV templates. Each template is fully
					customizable with multiple themes and layouts.
				</p>
			</div>
				...
				<div class="flex space-x-2 bg-gray-100 dark:bg-gray-700 rounded-lg p-1">
					{#each categories as category}
						<button
							...
							class="px-4 py-2 rounded-md text-sm font-medium transition-colors duration-200 {filterCategory ===
							category
		...
		<div class="grid lg:grid-cols-4 gap-8">
			...
			<div class="lg:col-span-1">
				<div class="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-6 sticky top-8">
					...
					<div class="space-y-3">
						{#each filteredTemplates as template}
							<button
								...
								class="w-full text-left p-3 rounded-lg border-2 transition-all duration-200 {selectedTemplate.id ===
								template.id
							...
							>
								...
								<div class="flex flex-wrap gap-1">
									{#each template.features.slice(0, 2) as feature}
										<span
											class="px-2 py-1 bg-gray-200 dark:bg-gray-600 text-xs rounded text-gray-700 dark:text-gray-300"
										>
											{feature}
										</span>
									{/each}
					...
					<!-- Theme Customization -->
					<div class="mt-8">
						<h3 class="text-lg font-semibold text-gray-900 dark:text-white mb-4">Themes</h3>
						<div class="space-y-2">
							{#each selectedTemplate.themes as theme}
								<button
									on:click={() => selectTheme(theme)}
									class="w-full flex items-center space-x-3 p-2 rounded-lg transition-colors duration-200 {selectedTheme.name ===
									theme.name
										? 'bg-blue-50 dark:bg-blue-900/20'
										: 'hover:bg-gray-50 dark:hover:bg-gray-700'}"
								>
									<div class="flex space-x-1">
										<div class="w-4 h-4 rounded-full bg-{theme.primary}" />
										<div class="w-4 h-4 rounded-full bg-{theme.secondary}" />
									</div>
					...
					<div class="mt-8">
						...
						<div class="flex space-x-2">
							<button
								...
								class="p-2 rounded-lg transition-colors duration-200 {previewMode === 'desktop'
							...
							<button
								...
								class="p-2 rounded-lg transition-colors duration-200 {previewMode === 'tablet'
									? 'bg-blue-100 dark:bg-blue-900/20 text-blue-600 dark:text-blue-400'
									: 'text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white'}"
								title="Tablet View"
							>
							...
							<button
								...
								class="p-2 rounded-lg transition-colors duration-200 {previewMode === 'mobile'
									? 'bg-blue-100 dark:bg-blue-900/20 text-blue-600 dark:text-blue-400'
									: 'text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white'}"
								title="Mobile View"
							>
			...
			<div class="lg:col-span-3">
				<div class="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-6">
					...
					<div class="mb-6">
						...
						<div class="flex flex-wrap gap-2">
							{#each selectedTemplate.features as feature}
								<span
									class="px-3 py-1 bg-blue-100 dark:bg-blue-900/20 text-blue-800 dark:text-blue-300 text-sm rounded-full"
								>
									{feature}
								</span>
							{/each}
					...
					<div class="border border-gray-200 dark:border-gray-600 rounded-lg overflow-hidden">
						...
						>
							<div
								class="transform {previewMode === 'mobile'
									? 'scale-75'
									: previewMode === 'tablet'
									? 'scale-90'
									: 'scale-100'} origin-top transition-transform duration-300"
							>
