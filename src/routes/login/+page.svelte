...
<div class="min-h-screen bg-gray-50 dark:bg-gray-900 flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
  <div class="max-w-md w-full space-y-8">
    ...
    <div class="text-center">
      <a href="/" class="inline-flex items-center text-gray-600 dark:text-gray-300 hover:text-blue-600 dark:hover:text-blue-400 mb-6" aria-label="Return to home page">
        <ArrowLeft class="w-4 h-4 mr-2" aria-hidden="true" />
        Back to Home
      </a>
      
      <div class="flex items-center justify-center mb-6">
        <div class="w-12 h-12 bg-gradient-to-br from-blue-600 to-blue-700 rounded-xl flex items-center justify-center shadow-lg hover:shadow-xl hover:shadow-blue-500/25 transition-all duration-300 hover:scale-105 hover:rotate-3" role="img" aria-label="SiteMe logo">
    ...
    <div class="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-8">
      {#if errorMessage}
        <div class="mb-4 p-4 bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 rounded-lg" role="alert" aria-live="polite">
          <p class="text-red-600 dark:text-red-400 text-sm">{errorMessage}</p>
        </div>
      {/if}

      {#if successMessage}
        <div class="mb-4 p-4 bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800 rounded-lg" role="alert" aria-live="polite">
      ...
      <form on:submit|preventDefault={handleEmailLogin} class="space-y-6" aria-label="Sign in form">
        ...
        <div>
          ...
          <div class="relative">
            ...
            >
              {#if showPassword}
                <EyeOff class="h-5 w-5 text-gray-400 hover:text-gray-600 dark:hover:text-gray-300" aria-hidden="true" />
              {:else}
                <Eye class="h-5 w-5 text-gray-400 hover:text-gray-600 dark:hover:text-gray-300" aria-hidden="true" />
              {/if}
            </button>
          </div>
        </div>
        ...
        <div class="flex items-center justify-between">
          ...
          <div class="text-sm">
            <a href="/forgot-password" class="font-medium text-blue-600 hover:text-blue-500 dark:text-blue-400 dark:hover:text-blue-300" aria-label="Reset your password">
      ...
      <div class="mt-6">
        ...
        <div class="mt-6">
          ...
          >
            {#if loading}
              <div class="flex items-center justify-center">
                <div class="animate-spin rounded-full h-5 w-5 border-b-2 border-gray-700 dark:border-white mr-2" aria-hidden="true"></div>
                Connecting...
              </div>
            {:else}
      ...
      <div class="mt-6 text-center">
        <p class="text-sm text-gray-600 dark:text-gray-300">
          ...
          <a href="/signup" class="font-medium text-blue-600 hover:text-blue-500 dark:text-blue-400 dark:hover:text-blue-300" aria-label="Create a new account">
            Sign up
          </a>
        </p>
      </div>
