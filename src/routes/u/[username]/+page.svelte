...
<svelte:head>
	<title>{profile?.data?.name || $page.params.username} - SiteMe</title>
	<meta
		name="description"
		content={profile?.data?.summary ||
			`View ${profile?.data?.name || $page.params.username}'s professional profile`}
	/>
</svelte:head>
	...
	{:else if error || !profile}
		<div class="flex items-center justify-center min-h-screen">
			<div class="text-center">
				<h1 class="text-2xl font-bold text-gray-900 dark:text-white mb-4">Profile Not Found</h1>
