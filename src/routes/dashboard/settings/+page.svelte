...
<div class="container mx-auto px-4 py-6">
	...
	<div class="flex items-center space-x-4 mb-8">
		...
		<div>
			<h1 class="text-2xl sm:text-3xl font-bold text-gray-900 dark:text-white">Account Settings</h1>
			<p class="text-gray-600 dark:text-gray-300">Manage your account preferences and security</p>
		</div>
	</div>
	...
	{:else}
		<div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
				...
				>
					<div class="flex items-center space-x-3 mb-6">
						...
						<div>
							...
							<p class="text-sm text-gray-600 dark:text-gray-300">Connect your social profiles</p>
						</div>
					</div>
				...
				>
					<div class="flex items-center space-x-3 mb-6">
						...
						<div>
							...
							<p class="text-sm text-gray-600 dark:text-gray-300">Manage your account security</p>
						</div>
					</div>
			...
			<div class="space-y-6">
				...
				<!-- Danger Zone -->
				<div
					class="bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-700 rounded-xl p-6"
				>
