...
{:else if site && resumeData}
  <div class="min-h-screen bg-gradient-to-br from-gray-50 via-blue-50 to-indigo-50 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900">
    <div class="container mx-auto px-4 py-8">
        ...
        <div class="flex items-center space-x-4">
          ...
          <div>
            <div class="flex items-center space-x-3">
              ...
              {:else}
                <span class="inline-flex items-center px-2 py-1 bg-gray-100 dark:bg-gray-600 text-gray-800 dark:text-gray-300 text-sm font-medium rounded-full">
                  Draft
                </span>
              {/if}
            </div>
      ...
      <!-- Tab Content -->
      <div class="bg-white/80 dark:bg-gray-800/80 backdrop-blur rounded-xl border border-gray-200/50 dark:border-gray-700/50">
