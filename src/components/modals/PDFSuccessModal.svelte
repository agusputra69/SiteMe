					...
					>
						<div class="flex items-center space-x-2">
							...
							<span class="text-sm font-medium text-blue-900 dark:text-blue-100">
								Extraction Quality: {stats.experience > 0 &&
								stats.education > 0 &&
								stats.skills > 0 &&
