				...
				<div class="space-y-4">
					...
					>
						<div class="flex items-start space-x-3">
							<div
								class="flex-shrink-0 p-2 bg-blue-100 rounded-lg group-hover:bg-blue-200 transition-colors"
							>
					...
					>
						<div class="flex items-start space-x-3">
							<div
								class="flex-shrink-0 p-2 bg-gray-100 rounded-lg group-hover:bg-gray-200 transition-colors"
							>
