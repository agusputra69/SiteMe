...
<div class="min-h-screen bg-white dark:bg-gray-900">
		...
		<div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
			<div class="flex justify-between items-center h-16">
				<div class="flex items-center space-x-3">
					...
					{:else}
						<div
							class="w-8 h-8 bg-gradient-to-br from-{theme.primary} to-{theme.secondary} rounded-full flex items-center justify-center text-sm font-bold text-white"
						>
							{avatarInitial}
						</div>
					{/if}
				...
				<div class="hidden md:flex space-x-8">
					<a
						href="#about"
						class="text-gray-600 dark:text-gray-300 hover:text-{theme.primary} transition-colors"
						>About</a
					>
					<a
						href="#experience"
	...
	<section class="pt-24 pb-16 px-4 sm:px-6 lg:px-8">
		<div class="max-w-4xl mx-auto text-center">
			...
			<div class="mb-8">
				...
				{:else}
					<div
						class="w-32 h-32 bg-gradient-to-br from-{theme.primary} to-{theme.secondary} rounded-full mx-auto flex items-center justify-center text-4xl font-bold text-white shadow-xl"
					>
						{avatarInitial}
					</div>
				{/if}
			...
			{#if profileData.workExperience && profileData.workExperience.length > 0}
				<p class="text-xl text-{theme.textSecondary} dark:text-gray-300 mb-8">
					...
					{#if profileData.workExperience[0].company}
						at <span class="text-{theme.primary} font-semibold"
				...
				<div class="flex justify-center space-x-4 mb-8">
					{#each profileData.links as link}
						<a
							...
							class="w-10 h-10 bg-gray-100 dark:bg-gray-800 rounded-full flex items-center justify-center text-{theme.textSecondary} hover:bg-{theme.primary} hover:text-white transition-all duration-300"
						>
			...
			{#if profileData.contact?.email}
				<a
					...
					class="inline-flex items-center px-6 py-3 bg-{theme.primary} text-white font-semibold rounded-lg hover:bg-{theme.secondary} transition-colors shadow-lg"
				>
	...
	<section id="about" class="py-16 px-4 sm:px-6 lg:px-8 bg-gray-50 dark:bg-gray-800">
		<div class="max-w-4xl mx-auto">
			<h2 class="text-3xl font-bold text-gray-900 dark:text-white mb-8 text-center">About Me</h2>
			...
			<div class="max-w-6xl mx-auto">
				...
				<div class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-4">
					{#each profileData.skills as skill, index}
						<div
							class="bg-white dark:bg-gray-800 rounded-lg p-4 text-center shadow-md hover:shadow-lg transition-shadow border border-gray-100 dark:border-gray-700"
						>
							{#if customizable}
								<input
			...
			<div class="max-w-6xl mx-auto">
				...
				<div class="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
					{#each profileData.certifications as cert, index}
						<div
							class="bg-white dark:bg-gray-900 rounded-2xl p-6 shadow-lg border border-gray-100 dark:border-gray-700"
						>
			...
			<div class="max-w-4xl mx-auto">
				...
				<div class="space-y-8">
					{#each profileData.workExperience as experience, index}
						<div
							class="bg-white dark:bg-gray-900 rounded-2xl p-8 shadow-lg border border-gray-100 dark:border-gray-700"
						>
							<div class="flex flex-col sm:flex-row sm:items-start sm:justify-between mb-4">
								<div class="flex-1">
									{#if customizable}
			...
			<div class="max-w-6xl mx-auto">
				...
				<div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
					{#each profileData.projects as project, index}
						<div
							class="bg-white dark:bg-gray-800 rounded-2xl overflow-hidden shadow-lg hover:shadow-xl transition-shadow border border-gray-100 dark:border-gray-700"
						>
							{#if project.image}
	...
	<section id="contact" class="py-16 px-4 sm:px-6 lg:px-8 bg-gray-50 dark:bg-gray-800">
		<div class="max-w-4xl mx-auto text-center">
			<h2 class="text-3xl font-bold text-gray-900 dark:text-white mb-8">Let's Connect</h2>
			...
			<div class="flex flex-col sm:flex-row gap-4 justify-center">
				...
				{#if profileData.contact?.phone}
					<a
						...
						class="inline-flex items-center px-6 py-3 border-2 border-{theme.primary} text-{theme.primary} font-semibold rounded-lg hover:bg-{theme.primary} hover:text-white transition-colors"
					>
						<svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
							<path
								stroke-linecap="round"
