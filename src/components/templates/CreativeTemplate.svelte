...
>
	<div
		class="{paddingClass} {fontClass} transition-all duration-300 bg-gradient-to-br from-slate-50 to-gray-100 dark:from-slate-900 dark:to-gray-800 text-gray-900 dark:text-gray-100"
	>
		<div class="{containerClass} mx-auto">
			...
			<div class="relative mb-16">
				...
				<div class="absolute inset-0 overflow-hidden">
					<div
						class="absolute top-0 left-0 w-72 h-72 bg-gradient-to-br from-purple-600/20 to-pink-500/20 rounded-full blur-3xl"
					/>
					<div
						class="absolute top-20 right-0 w-96 h-96 bg-gradient-to-bl from-pink-500/15 to-purple-600/15 rounded-full blur-3xl"
					/>
				</div>
				...
				<div class="relative z-10 text-center py-20">
					<div
						class="w-32 h-32 mx-auto mb-8 bg-gradient-to-br from-purple-600 to-pink-500 rounded-full flex items-center justify-center text-white text-4xl font-bold shadow-2xl transform rotate-3 hover:rotate-0 transition-transform duration-300 overflow-hidden"
					>
						{#if isImageUrl}
							<img
					...
					<h1
						class="text-6xl font-extrabold bg-gradient-to-r from-purple-600 to-pink-500 bg-clip-text text-transparent mb-4"
					>
						{#if customizable}
							<input
						...
						<div class="flex justify-center space-x-8 text-gray-600 dark:text-gray-300">
							{#if profileData.contact.email}
								<div class="flex items-center space-x-2">
									<span class="w-2 h-2 bg-purple-600 rounded-full" aria-hidden="true" />
									<span aria-label="Email address">{profileData.contact.email}</span>
								</div>
							{/if}
							{#if profileData.contact.phone}
								<div class="flex items-center space-x-2">
									<span class="w-2 h-2 bg-pink-500 rounded-full" aria-hidden="true" />
							...
							{#if profileData.contact.location}
								<div class="flex items-center space-x-2">
									<span
										class="w-2 h-2 bg-gradient-to-r from-purple-600 to-pink-500 rounded-full"
										aria-hidden="true"
									/>
			...
			<div class="grid lg:grid-cols-3 gap-8">
				...
				<div class="lg:col-span-2 {spacingClass}">
					<!-- About Section -->
					<div
						class="bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm rounded-3xl p-8 shadow-xl border border-white/20"
					>
						<div class="flex items-center mb-6">
							<div
								class="w-1 h-8 bg-gradient-to-b from-purple-600 to-pink-500 rounded-full mr-4"
								aria-hidden="true"
							/>
							<h2 class="text-3xl font-bold text-gray-900 dark:text-gray-100">About Me</h2>
						</div>
						{#if customizable}
							<textarea
					...
					>
						<div class="flex items-center mb-8">
							<div
								class="w-1 h-8 bg-gradient-to-b from-pink-500 to-purple-600 rounded-full mr-4"
								aria-hidden="true"
							/>
							<h2 class="text-3xl font-bold text-gray-900 dark:text-gray-100">Experience</h2>
						</div>
						...
						<div class="space-y-8">
							{#each profileData.workExperience || [] as experience, index}
								<div class="relative">
									<!-- Timeline dot -->
									<div
										class="absolute -left-4 top-6 w-4 h-4 bg-gradient-to-br from-purple-600 to-pink-500 rounded-full border-4 border-white dark:border-gray-800 shadow-lg"
										aria-hidden="true"
									/>

									<div
										class="bg-gradient-to-r from-purple-100/30 to-transparent dark:from-purple-600/10 dark:to-transparent rounded-2xl p-6 ml-4 border-l-4 border-purple-600/30"
									>
				...
				<div class={spacingClass}>
					...
					{#if profileData.skills && profileData.skills.length > 0}
						<div
							class="bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm rounded-3xl p-6 shadow-xl border border-white/20"
						>
							<div class="flex items-center mb-6">
								<div
									class="w-1 h-6 bg-gradient-to-b from-purple-600 to-pink-500 rounded-full mr-3"
									aria-hidden="true"
								/>
							...
							<div class="flex flex-wrap gap-3">
								{#each profileData.skills || [] as skill, index}
									<span
										class="px-4 py-2 bg-gradient-to-r from-purple-600/20 to-pink-500/20 text-purple-800 dark:text-purple-200 rounded-full text-sm font-medium border border-purple-600/30 hover:scale-105 transition-transform duration-200"
									>
										{skill}
									</span>
								{/each}
					...
					>
						<div class="flex items-center mb-6">
							<div
								class="w-1 h-6 bg-gradient-to-b from-pink-500 to-purple-600 rounded-full mr-3"
								aria-hidden="true"
							/>
						...
						<div class="space-y-4">
							{#each profileData.education as edu, index}
								<div
									class="bg-gradient-to-r from-purple-100/20 to-transparent dark:from-purple-600/5 dark:to-transparent rounded-xl p-4 border-l-4 border-pink-500"
								>
						...
						>
							<div class="flex items-center mb-6">
								<div
									...
									aria-hidden="true"
								/>
								<h2 class="text-2xl font-bold text-gray-900 dark:text-white">Certifications</h2>
							</div>
							<div class="space-y-4">
						...
						>
							...
							<div class="space-y-3">
								{#each profileData.languages as language}
									<div
										class="flex justify-between items-center p-3 bg-gradient-to-r from-purple-50 to-pink-50 dark:from-purple-900/20 dark:to-pink-900/20 rounded-xl"
									>
										...
										{#if project.technologies && project.technologies.length > 0}
											<div class="flex flex-wrap gap-2">
												{#each project.technologies as tech}
													<span
														class="text-xs px-2 py-1 bg-gradient-to-r from-purple-600/20 to-pink-500/20 text-purple-800 dark:text-purple-200 rounded-full border border-purple-600/30"
													>
														{tech}
													</span>
												{/each}
						...
						>
							<div class="flex items-center mb-6">
								<div
									...
									aria-hidden="true"
								/>
								<h2 class="text-2xl font-bold text-gray-900 dark:text-white">Awards</h2>
							</div>
							<div class="space-y-4">
						...
						>
							<div class="flex items-center mb-6">
								<div
									...
									aria-hidden="true"
								/>
								<h2 class="text-3xl font-bold text-gray-900 dark:text-gray-100">Links</h2>
							</div>
							<div class="space-y-4">
								{#each profileData.links as link}
									...
									>
										<div
											class="w-12 h-12 bg-gradient-to-br from-purple-600 to-pink-500 rounded-xl flex items-center justify-center mr-4 text-white font-bold text-lg shadow-lg"
										>
											{link.type.charAt(0).toUpperCase()}
										</div>
										<div class="flex-1">
											<div
												class="font-bold text-gray-900 dark:text-gray-100 group-hover:text-purple-600 dark:group-hover:text-purple-400 transition-colors"
											>
												{link.type}
											</div>
										...
										<svg
											class="w-5 h-5 text-purple-600 group-hover:text-pink-500 transition-colors"
											fill="none"
											stroke="currentColor"
											viewBox="0 0 24 24"
										>
