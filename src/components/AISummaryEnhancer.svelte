...
${enhancementLevel === 'detailed' ? 'Provide a more detailed version with specific examples and achievements.' : ''}
${enhancementLevel === 'executive' ? 'Focus on leadership, strategic thinking, and executive-level achievements.' : ''}
